              ...
              expectations. Let's connect and create something amazing together! */}
                    ...
                    <div className=" w-full flex  md:w-2/5 md:mt-2  mt-10 -ml-2 ">
                        ...
                        <div className={`flex p-1 gap-4 fixed right-3 z-20 transition-transform duration-500 ease-out ${open ? "translate-x-0" : "translate-x-2"}`}>
                            ...
                            {open && (
                                <div className={`space-y-2 -mt-1 w-fit rounded-lg p-2 transition-all duration-500 ease-out ${open ? "scale-100 opacity-100 translate-y-0" : "scale-95 opacity-0 -translate-y-4"} ${theme === "dark" ? "bg-bgBlack text-textWhite" : "bg-bgblack50"}`}>
                                    <h2>Theme Color</h2>
