...
const ModalCard = ({ showModal, project, handleCloseModal }) => {
  ...
  return (
    <>
      ...
      <div className='fixed  top-28 left-10 rounded-2xl md:top-24 md:left-36 md:w-[80%]  w-[75%] max-h-[80vh]  overflow-y-auto border bg-bgblack900 dark:bg-bgColor bg-opacity-100 z-50 p-4 flex flex-col border-primaryColor shadow-[0_0px_15px_-1px_#02ff02]' >
